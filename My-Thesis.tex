...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, breakable, bottomrule=.15mm, toprule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, colback=white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}]
