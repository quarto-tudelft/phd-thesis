...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, toptitle=1mm, leftrule=.75mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, arc=.35mm, coltitle=black, breakable]
